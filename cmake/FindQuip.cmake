...
find_package_handle_standard_args(Quip DEFAULT_MSG QUIP_INCLUDE_DIRS QUIP_LIBRARIES)

if (QUIP_FOUND AND NOT TARGET quip::quip)
  add_library(quip::quip INTERFACE IMPORTED)
  set_target_properties(quip::quip PROPERTIES
    INTERFACE_INCLUDE_DIRECTORIES "${QUIP_INCLUDE_DIRS}"
